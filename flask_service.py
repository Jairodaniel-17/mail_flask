...
class FlaskAppService(win32serviceutil.ServiceFramework):
    _svc_name_ = "FlaskMailService"
    _svc_display_name_ = "Flask Mail API Service"
    _svc_description_ = (
        "Servicio para enviar correos electrónicos a través de una API Flask."
    )
    ...
    def main(self):
        ...
        script_dir = r"C:/Users/jairo/servicios_python/email"
